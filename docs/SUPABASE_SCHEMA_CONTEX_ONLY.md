...
CREATE TABLE public.app_permissions (
  ...
  CONSTRAINT app_permissions_pkey PRIMARY KEY (key_name)
);
CREATE TABLE public.customers (
  ...
  CONSTRAINT customers_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspaces(id)
);
...
CREATE TABLE public.workspaces (
  ...
  name text NOT NULL,
  code text NOT NULL DEFAULT generate_workspace_code() UNIQUE,
  created_at timestamp with time zone DEFAULT now(),
