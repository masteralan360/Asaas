...
>(({ className, children, allowViewer = false, disabled, ...props }, ref) => {
    ...
    return (
        <SelectPrimitive.Trigger
            ...
            className={cn(
                "flex h-10 w-full items-center justify-between rounded-xl border border-border/80 bg-background/80 px-3 py-2 text-sm shadow-sm shadow-black/[0.03] ring-offset-background placeholder:text-muted-foreground transition-all hover:border-primary/45 hover:bg-background focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-background/50 [&>span]:line-clamp-1",
                className
            )}
            {...props}
        >
