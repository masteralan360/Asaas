CREATE TABLE public.workspace_usage (
  ...
  actual_data_transfer_bytes bigint NOT NULL DEFAULT 0,
  ...
  CONSTRAINT workspace_usage_actual_transfer_nonnegative_check CHECK (actual_data_transfer_bytes >= 0),
  ...
  CONSTRAINT workspace_usage_transfer_counters_consistent_check
    CHECK (data_transfer_bytes::numeric = actual_data_transfer_bytes::numeric * 10::numeric),
